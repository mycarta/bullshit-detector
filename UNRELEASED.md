...
- HARKing detection module (from World Happiness project handoff): `harking.py` (Davies test + bootstrap breakpoint stability) + `harking_detection.md` skill file + tutorial example. Fills the explicit gap in arithmetic_consistency.md "not covered" section. Tier 2/3. Source: `04_harking_tutorial.ipynb`.
